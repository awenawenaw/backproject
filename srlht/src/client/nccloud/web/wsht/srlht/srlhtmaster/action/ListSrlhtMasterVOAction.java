 ...
 * 列表查询
 */
public class ListSrlhtMasterVOAction extends BaseAction{
	...
	public Object doAction(IRequest request, RequstParamWapper paramWapper) throws Throwable{
		...
		//查询当前方案下所有的数据pk
		String[] allpks = service.listSrlhtMasterVOPkByCond(searchSql);
		...
		SrlhtMasterVO[] vos =  service.listSrlhtMasterVOByPk(curPagePks);
		//构造返回结果
