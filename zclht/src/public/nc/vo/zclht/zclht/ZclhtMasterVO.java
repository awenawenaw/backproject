...
public class ZclhtMasterVO extends SuperVO {

	//构造方法
	public ZclhtMasterVO() {
		super();
	}
	...
	@Override
	@nc.vo.annotation.MDEntityInfo(beanFullclassName =  "nc.vo.zclht.zclht.ZclhtMasterVO" )
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("zclht.zclhtMaster");
  	}
