 ...
 * 列表查询
 */
public class ListZclhtMasterVOAction extends BaseAction{
	...
	public Object doAction(IRequest request, RequstParamWapper paramWapper) throws Throwable{
		...
		//查询当前方案下所有的数据pk
		String[] allpks = service.listZclhtMasterVOPkByCond(searchSql);
		...
		ZclhtMasterVO[] vos =  service.listZclhtMasterVOByPk(curPagePks);
		//构造返回结果
